export const initialUsers = [
  {
    ...
    skills: ["React", "TypeScript", "Node.js", "Figma", "TailwindCSS", "Python"]
  },
  {
    id: "usr-google",
...
export const initialInternships = [
  // Google
  {
    ...
    maxPositions: 6,
    filledPositions: 2,
    skillsRequired: ["Go", "Kubernetes", "Distributed Systems", "gRPC"],
  ...
  },
  {
    ...
    maxPositions: 4,
    filledPositions: 1,
    skillsRequired: ["Python", "PyTorch", "Transformers", "JAX"],
  ...
  // Microsoft
  {
    ...
    maxPositions: 5,
    filledPositions: 2,
    skillsRequired: ["Azure", "Terraform", "C#", ".NET Core", "Docker"],
  ...
  },
  {
    ...
    maxPositions: 4,
    filledPositions: 1,
    skillsRequired: ["PowerBI", "SQL", "Azure Synapse", "Python"],
  ...
  // Amazon
  {
    ...
    maxPositions: 8,
    filledPositions: 3,
    skillsRequired: ["Java", "AWS Lambda", "DynamoDB", "TypeScript"],
  ...
  },
  {
    ...
    companyName: "Amazon",
    companyLogo: "https://images.unsplash.com/photo-1523474253243-231a51138b38?w=120&auto=format&fit=crop&q=80",
    title: "Applied Machine Learning Intern (Search & Recommendations)",
    category: "Data",
    stipend: "$8,500 / mo",
    stipendAmount: 8500,
    durationWeeks: 12,
    ...
    maxPositions: 4,
    filledPositions: 1,
    skillsRequired: ["Python", "Deep Learning", "AWS SageMaker", "Spark"],
    description: "Develop personalized recommendation systems that dynamically surface relevant items for over 300 million active shoppers.",
    responsibilities: [
      "Train two-tower neural retrieval models using PyTorch on AWS SageMaker",
      "Engineer candidate generation pipelines processing terabytes of clickstream logs",
      "Run live A/B experiments measuring relevance lift and click-through rates"
    ],
    requirements: [
      "Strong foundations in recommendation systems, ranking models, and Python",
      "Experience with PyTorch or TensorFlow and distributed computing"
    ]
  },
  ...
  // TCS
  {
    ...
    maxPositions: 10,
    filledPositions: 4,
    skillsRequired: ["Java 17", "Spring Boot", "Kafka", "PostgreSQL"],
  ...
  },
  {
    ...
    companyName: "Tata Consultancy Services (TCS)",
    companyLogo: "https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=120&auto=format&fit=crop&q=80",
    title: "Cloud Security & Governance Analyst Intern",
    category: "Tech",
    stipend: "$2,800 / mo",
    stipendAmount: 2800,
    durationWeeks: 12,
    durationText: "12 Weeks (Fall 2026)",
    location: "Bangalore, India",
    remote: true,
    status: "ACTIVE",
    maxPositions: 6,
    filledPositions: 2,
    skillsRequired: ["Cybersecurity", "Cloud Architecture", "ISO 27001", "Python"],
    description: "Audit enterprise cloud compliance and build automated scanning scripts for vulnerability detection across hybrid cloud assets.",
    responsibilities: [
      "Automate security compliance checks across multi-cloud tenants with Python",
      "Analyze network vulnerability reports and coordinate remediation tickets",
      "Assist in zero-trust architecture documentation and IAM policy audits"
    ],
    requirements: [
      "Knowledge of cloud security principles, network protocols, and scripting in Python",
      "Passion for defensive cybersecurity and cloud governance"
    ]
  },
...
export const platformMetrics = {
  totalStudents: 14280,
  activeInternships: 840,
  verifiedCompanies: 320,
  ...
  categoryBreakdown: [
    { category: "Tech", count: 520, percentage: 55 },
    { category: "Data / AI", count: 210, percentage: 22 },
    { category: "Design", count: 130, percentage: 14 },
    { category: "Marketing", count: 55, percentage: 6 },
    { category: "Finance", count: 25, percentage: 3 }
  ]
};
